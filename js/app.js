...
var newTweets = [{
    tweet: "Walks in the park and time in #nature are the safest places for our children during the pandemic",
...
},
{
    ...
    username: "Ann", created_at: "02/02/2020", age: 17
},
{
    tweet: "Environmental groups have been ringing alarm bells over selenium pollution.",
    username: "James", created_at: "03/02/2020", age: 15
},
{
...
},
{
    ...
    username: "Rini", created_at: "03/04/2020", age: 20
},
{
...
},
{
    ...
    username: "Rachel", created_at: "04/06/2020", age: 16
},
{
...
},
{
    ...
    username: "Karey", created_at: "06/15/2020", age: 13
}
];
...
function resultant(newTweets) {
    if (newTweets.age >= 18) {
        return true;
    }
    else if (newTweets.age < 18) {
...
for (var i = 0; i < newTweets.length; i++) {
    console.log(newTweets[i].age);
    var newlist1 = resultant(newTweets[i]);
    console.log(newlist1);

}

var newlist = newTweets.filter(resultant);
console.log(newlist);
